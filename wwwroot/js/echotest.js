...
if(window.location.protocol === 'http:')
	server = "http://" + window.location.hostname + ":44340/janus";
else
	server = "https://" + window.location.hostname + ":44340/janus";
console.log(server);
var janus = null;
var echotest = null;
						...
						janus.attach(
							{
								...
								onlocalstream: function(stream) {
									...
									if($('#myvideo').length === 0) {
										...
										$('#videoleft').append('<video class="rounded centered" id="myvideo"  autoplay playsinline muted="muted"/>');
									}
									...
									if(echotest.webrtcStuff.pc.iceConnectionState !== "completed" &&
										...
										// No remote video yet
										$('#videoright').append('<video class="rounded centered" id="waitingvideo"  />');
										if(spinner == null) {
