...
namespace VirusHackKodShredinger.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Group")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name,Group")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
